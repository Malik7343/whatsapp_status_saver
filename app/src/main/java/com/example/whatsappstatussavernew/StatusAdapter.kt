...
class StatusAdapter(private val context: Context,
         private val modelClass: ArrayList<ModelClass>,private val clickListener:(ModelClass)->Unit):
          RecyclerView.Adapter<StatusAdapter.StatusViewHolder>(){
              ...
              class StatusViewHolder(itemView:View):RecyclerView.ViewHolder(itemView)
              {
                  ...
                  val cvVideoCard:CardView=itemView.findViewById(R.id.iv_video_card)
              }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StatusViewHolder {
        return StatusViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.status_items,parent,false)
        )
    }
